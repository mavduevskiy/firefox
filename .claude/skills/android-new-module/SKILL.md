...
**Common upstream_dependencies:**
- Basic support: `components:support-base`, `components:support-ktx`, `components:support-test`
- Linting: `components:tooling-lint`
- State: `components:lib-state`
- Browser state: `components:browser-state`
- Engine: `components:concept-engine`
